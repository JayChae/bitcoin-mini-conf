export const seoMessages = {
  en: {
    ...
    description:
      "Bitcoin Mini Conference 2025 in Seoul led by Community, South Korea. Two days of Bitcoin education, networking, and community building on November 29-30.",
    keywords:
    ...
    ogDescription:
      "Bitcoin Mini Conference 2025 in Seoul, South Korea. Two days of Bitcoin education, networking, and community building on November 29-30.",
    ...
    audience: "Bitcoin enthusiasts, developers, investors",
    robots: "index, follow",
  ...
  ko: {
    ...
    description:
      "비트코인 미니 컨퍼런스. 국내 유일 커뮤니티 주도 컨퍼런스, 2025년 11월 29-30일 서울에서 비트코인 교육, 네트워킹, 커뮤니티 활동.",
    keywords:
      "비트코인, 컨퍼런스, 서울, 한국, 암호화폐, 블록체인, 교육, 커뮤니티, 2025",
    ogTitle: "비트코인 미니 컨퍼런스 2025 - 서울",
    ogDescription: "비트코인 미니 컨퍼런스. 비트코인 교육, 네트워킹, 커뮤니티.",
    twitterTitle: "비트코인 미니 컨퍼런스 2025 - 서울",
    twitterDescription:
      "비트코인 미니 컨퍼런스. 비트코인 교육, 네트워킹, 커뮤니티.",
